    ...
    <>
      ...
      <Drawer open={open} onClose={closeDrawer} className="p-4">
        <div className="mb-6 flex items-center justify-between">
          <Typography variant="h5" color="blue-gray" className="label">
            BrewCraft.
          </Typography>
...
function NavBarIconGroup() {
  const PROFILE_SVG = (
    <svg
      ...
      strokeWidth={1.5}
      stroke="currentColor"
      className="w-6 h-6 text-cp-dark hover:cursor-pointer"
    >
      <path
        strokeLinecap="round"
        strokeLinejoin="round"
  ...
  const CART_SVG = (
    <svg
      ...
      stroke-width="1.5"
      stroke="currentColor"
      class="w-6 h-6 text-cp-dark hover:cursor-pointer"
    >
      <path
        stroke-linecap="round"
        stroke-linejoin="round"
  ...
  return (
    <div className="flex gap-x-5">
      ...
      <ThemeProvider value={customMenu}>
        <Menu>
          <MenuHandler>{CART_SVG}</MenuHandler>
          <MenuList>
            <MenuItem>
              <div className="w-[300px] flex justify-between">
                <img
                  src="https://cdn-icons-png.flaticon.com/512/3811/3811319.png"
                  alt=""
                  className="w-20 h-20"
                />
                <div className="flex flex-col justify-center items-center">
                  <div>Some Coffee Item</div>
                  <div>In Cart: 2</div>
                </div>
              </div>
            </MenuItem>
